...
<div id="contentsys">
    ...
    <div class="sysright">
        ...
        <form id="form" action="#" method="post" enctype="multipart/form-data">
            ...
            <!-- 本段标题（分段标题） -->
            <div >
                <a href="foodList.jsp"><img src="../../img/sys/back.jpg" style="width: 30px;height: 30px"></a>&nbsp;
            ...
            <div class="foodadd">
                ...
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    ...
                    <tr>
                        <td>菜名</td>
                        <td><input type="text" id="foodName" name="foodName" value="把子肉" onblur="ajaxFoodName()"/> *</td>
                    </tr>
                    <tr>
                        <td>价格</td>
                        <td><input type="text" placeholder="最多两位小数"  onblur="ajaxPrice()" id="price" name="price" value="8.0"/> *</td>
                    </tr>
                    <tr>
                        <td>简介</td>
                        <td><textarea name="remark" value="" id="remark" >济南名吃</textarea></td>
                    </tr>
                    <tr>
                        <td>菜品图片</td>
                        <td>
                    ...
                    <tr>
                        <td  colspan="2">
                            <img id="preview" src="../../img/app/food/9c4a81bc-0ffb-40ea-8c0d-7cfc73f4cd83.jpg"
